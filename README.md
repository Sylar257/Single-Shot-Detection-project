...
<b>Faster R-CNN</b>, <b>YOLO</b>, <b>SSD</b>, and <b>RetinaNet</b> are some most popular algorithm for object detection. In this project,  we will dive deep into <b>SSD</b> with PyTorch and investigate various techniques for training better DL models such as: <i>learning rate annealing</i>, <i>Kaiming_init</i>, <i>batchnorm</i>, and <i>adaptive loss weighting</i> 

<b>Spoiler alert</b>: we will be able to produce even better results that the origianl paper ^ ^
