- - # README
    ...
    *   Phase I: Vannila SSD300. Exact replicate of the [original paper](https://arxiv.org/pdf/1512.02325.pdf).
    *   Phase II: We implement better initialization techniques and implement learning rate annealing
    *   Phase III: Applying batchnorm to just base/auxiliary/both and comparing transfer learning and training-from-scratch
  *   Phase IV: 
